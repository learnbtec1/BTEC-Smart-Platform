...
def run():
    ...
    if r.status_code == 200:
        ...
        a = {"title": "Debug Assignment", "description": "desc", "module_name": "Unit D"}
        ra = client.post(f"{settings.API_V1_STR}/assignments/", headers=headers, json=a)
        print("create assignment status:", ra.status_code)
        print(ra.text)
